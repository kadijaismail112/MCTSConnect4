...
def main():
    ...
    if test > 1 and test <= 4:
        ...
        if test == 2:
            ...
            heuristic = "random"
        print(" MCTS won ", MCTS_wins, " out of 1000 games against ", heuristic, " heuristic. \n")
        print( heuristic, " heuristic won ", heuristic_wins, " out of 1000 games against MCTS. \n")
        print(" There were ", draws, " draws out of 1000 games between MCTS and ", heuristic, " heuristic. \n")
...
# add if statements before print statements so that they do not execute in test mode (pass into class constructor)
